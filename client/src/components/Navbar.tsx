  ...
  return (
    <nav className="w-full px-6 py-4 flex items-center justify-between border-b border-white/5 bg-[#161a25]">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xl font-bold text-white tracking-tight">SkillGap</span>
      </div>
      ...
      <div className="flex items-center gap-4">
        <Link
          to="/profile"
          className="flex items-center gap-2 pl-1 pr-3 py-1 rounded-full bg-gradient-to-br from-[#1e2433] to-[#161a25] border border-white/10 hover:border-[#38e5b1]/50 transition-colors"
        >
          ...
          <span className="text-sm font-medium text-white">{skills.length} Skills</span>
        </Link>
        <button
          onClick={logout}
