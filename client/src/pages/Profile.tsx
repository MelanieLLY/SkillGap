...
const Profile: React.FC = () => {
  ...
  const { skills, isLoading, error, loadSkills, addSkill, removeSkill, extractFromResume } =
    useProfileStore();
    ...
    <div className="min-h-screen bg-[#0f1117] flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto p-6 md:p-8 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold text-white tracking-tight">Skill Profile Setup</h1>
          <p className="text-[#9aa0ac] text-lg max-w-2xl text-balance">
            Define your expertise. Add your skills manually or paste your resume and let our engine
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-6">
            <div className="p-6 rounded-2xl bg-[#161a25] border border-white/5 flex flex-col gap-5 h-full">
              ...
              <p className="text-[#9aa0ac] text-sm">
                Paste the text from your resume or LinkedIn profile, and we'll automatically detect
